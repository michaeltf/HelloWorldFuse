...
public partial class MainView: Fuse.App
{
    ...
    void InitializeUX()
    {
        ...
        var temp6 = new Fuse.WebSocket.WebSocketClientModule();
        ...
        myRectangle_Color_inst = new HelloWorld_FuseControlsShape_Color_Property(myRectangle, __selector0);
        myRectangle_CornerRadius_inst = new HelloWorld_FuseControlsRectangle_CornerRadius_Property(myRectangle, __selector1);
        __g_nametable = new global::Uno.UX.NameTable(null, __g_static_nametable);
        var temp = new Fuse.Reactive.Each();
        temp_Items_inst = new HelloWorld_FuseReactiveEach_Items_Property(temp, __selector2);
        myBlur = new Fuse.Effects.Blur();
        myBlur_Radius_inst = new HelloWorld_FuseEffectsBlur_Radius_Property(myBlur, __selector3);
